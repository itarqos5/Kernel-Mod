...
- Full-world shader-pack compatibility: terrain/geometry replacement, shadows, depth effects, multiple color buffers, custom textures, shader properties/options and general conditional-include preprocessing. The limited color post-processing pipeline does not imply support for popular full-world shader packs.
