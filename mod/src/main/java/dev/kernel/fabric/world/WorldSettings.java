...
public final class WorldSettings {
    ...
    private static WorldConfig load() {
        try { return WorldConfig.load(PATH); }
            ...
            org.slf4j.LoggerFactory.getLogger("Kernel").warn("Cannot read world settings; leaving biome selection unchanged", exception);
            return new WorldConfig(false);
        }
    }
    ...
    public static boolean restartRequired(WorldConfig draft) { return !LITHIUM && draft.biomeOffsets() != ACTIVE.biomeOffsets(); }
